...
const Header: React.FC = () => {
  return (
    <header className="fixed top-0 left-0 w-full py-16 overflow-hidden z-50 bg-black">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold text-center tracking-tight bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 text-transparent bg-clip-text">
        ...
        <div className="w-32 h-1 bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 mx-auto mt-6 rounded-full"></div>
      </div>
    </header>
  );
};
